...
const MisInscripciones=()=>{
    ...
    return(
        ...
        <div>
            ...
            <h1 className='text-3xl font-bold my-4'>Inscripciones: {userData.nombre+' '+userData.apellido}</h1>
                ...
                <tbody>
                    ...
                    data.inscripcionByEstudiante.map((u)=>{
                        ...
                        <tr key={u._id}>
                            ...
                            <td>
                                {u.estado ==="ACEPTADO"?
                                <div><Link to={`/misInscripciones/crearAvance/${u.proyecto._id}/${u.estudiante._id}`}><i className="fas fa-plus text-yellow-600 hover:text-yellow-400 cursor-pointer">Avance</i></Link></div>:
                                u.estado === "PENDIENTE"?
                                <div>Pendiente</div>:
                                <div>Rechazado</div>}
                            </td>
